...
public class Dashbord_processus {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Dashbord_processus window = new Dashbord_processus();
	...
	private void initialize() {
		...
		lblProcessus.setHorizontalAlignment(SwingConstants.CENTER);
		lblProcessus.setForeground(Color.WHITE);
		lblProcessus.setFont(new Font("Tahoma", Font.PLAIN, 20));
		lblProcessus.setBounds(320, 132, 318, 38);
		frame.getContentPane().add(lblProcessus);
