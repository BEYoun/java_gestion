...
private ArrayList<Employee> chefs;
private ArrayList<Processus> processus;
...
public TreeDragDemo(JPanel panel, ArrayList<Employee> employees, ArrayList<Employee> chef){
		panel.setLayout(new BorderLayout());
	    this.employees= employees;
	    this.chefs=chef;
	    this.processus = pctl.getProcessus();
